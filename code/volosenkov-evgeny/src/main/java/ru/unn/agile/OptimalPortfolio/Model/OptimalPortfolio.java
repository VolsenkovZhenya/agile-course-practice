...
public class OptimalPortfolio {
    ...
    public static int [] GetArrayIdOptimumPortfolios( final ArrayList <Portfolio> optimumPortfolios) {
    ...
    private static boolean FindOptimalPortfolioParreto(final ArrayList <Portfolio> portfolios, final ArrayList <Portfolio> optimumPortfolios ) {
